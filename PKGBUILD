...
_extramodules=$(find /usr/lib/modules -type d -iname 6.1.46*xanmod* | rev | cut -d "/" -f1 | rev)
...
build() {
    _kernver=$(find /usr/lib/modules -type d -iname 6.1.46*xanmod* | rev | cut -d "/" -f1 | rev)
